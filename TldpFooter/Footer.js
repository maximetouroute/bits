        ...
        return (
          ...
          <div className={"Inside"}>
            ...
            <div className={'tldpLogo'}>  
              ...
              <p><strong>EMAIL  </strong><a href="mailto:livedrawingproject@pm.me">livedrawingproject@pm.me</a></p>
              <p><strong>Maxime HURDEQUINT    </strong><a href="telto:+336 78 75 61 50">+33 6 78 75 61 50</a></p>
            ...
            <div className={'followUs'}>
              ...
              <p><strong>Facebook    </strong><a href={links.facebook}  target="_blank" rel="noreferrer noopener">@TheLiveDrawingProject</a></p>
              <p><strong>Instagram    </strong><a href={links.instagram}  target="_blank" rel="noreferrer noopener">@livedrawingproject</a></p>
            </div>
            </div>
