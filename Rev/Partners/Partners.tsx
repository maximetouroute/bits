  ...
  return (
    <>
      ...
      <div css={markeeContainerCSS}>
            ...
            <a css={imageBackgroundForMarqueeCSS(logoClient_nimes)} href={'https://nimesartethistoire.fr/'} rel={'noopener noreferrer'}  target={'_blank'}>
            </a>
            </div>

            <div css={marqueChildCSS(height)}>
            <a href={'https://natachapaquignon.com/'} rel={'noopener noreferrer'}  target={'_blank'}>
            <StaticImage
              src={logoRawClient_1}
            ...
            <div css={marqueChildCSS(height)}>
            <a href={'https://www.lecubegarges.fr/'} rel={'noopener noreferrer'}  target={'_blank'}>
            <StaticImage
              src={logoRawClient_2}
              alt="Le Cube"
              placeholder="blurred"
            ...
            <div css={marqueChildCSS(height)}>
            <a href={'https://saintex-reims.com/'} rel={'noopener noreferrer'}  target={'_blank'}>
            <StaticImage
              src={logoRawClient_3}
              alt="Saint Ex"
              placeholder="blurred"
...
<div css={marqueChildCSS(height)}>
            <a href={'https://www.snzn.org/'} rel={'noopener noreferrer'}  target={'_blank'}>
            <StaticImage
              src={logoRawClient_4}
            ...
            <div css={marqueChildCSS(height)}>
            <a href={'https://aadn.org/'} rel={'noopener noreferrer'}  target={'_blank'}>
            <StaticImage
              src={logoRawClient_5}
              alt="AADN"
              placeholder="blurred"
            ...
            <div css={marqueChildCSS(height)}>
            <a href={'https://www.cite-sciences.fr/fr/au-programme/lieux-ressources/carrefour-numerique2'} rel={'noopener noreferrer'}  target={'_blank'}>
            <StaticImage
              src={logoRawClient_6}
      ...
      <div css={markeeContainerCSS}>
            ...
            <div css={marqueChildCSS(height)}>
            <a css={imageBackgroundForMarqueeCSS(logoPartner_idf)} href={'https://www.iledefrance.fr'} rel={'noopener noreferrer'}  target={'_blank'}>
            </a>
            </div>

            <div css={marqueChildCSS(height)}>
            <a css={imageBackgroundForMarqueeCSS(logoPartner_polepixel)} href={'https://polepixel.fr/'} rel={'noopener noreferrer'}  target={'_blank'}></a>
           </div>
            <div css={marqueChildCSS(height)}>
            <a css={imageBackgroundForMarqueeCSS(logoPartner_stationf)} href={'https://stationf.co/'} rel={'noopener noreferrer'}  target={'_blank'}></a>

            </div>
            <div css={marqueChildCSS(height)}>
            <a css={imageBackgroundForMarqueeCSS(logoPartner_bpi)} href={'https://www.bpifrance.fr/'} rel={'noopener noreferrer'}  target={'_blank'}></a>

            </div>
            
            <div css={marqueChildCSS(height)}>
            <a href={'https://www.theschoolab.com/en/'} rel={'noopener noreferrer'}  target={'_blank'}>
             <StaticImage
            ...
            <div css={marqueChildCSS(height)}>
            <a href={'https://www.parisandco.com/expertises/industries-culturelles-creatives/'} rel={'noopener noreferrer'}  target={'_blank'}>
            <StaticImage
