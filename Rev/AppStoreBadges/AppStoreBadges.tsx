...
export default function AppStoreBadges() {
  return (
    ...
    <Link css={appleBadgeCSS} to={'https://apps.apple.com/app/reveality/id1619973575'} target="_blank" rel="noopener"></Link>
      <Link css={googleBadgeCSS} to={'https://play.google.com/store/apps/details?id=io.reveality.app'}  target="_blank" rel="noopener">
    </Link>
    </div>
  );
}
